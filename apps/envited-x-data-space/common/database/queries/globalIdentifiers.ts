...
export const insertGlobalIdentifierTx =
  (
    tx: PgTransaction<
      AwsDataApiPgQueryResultHKT | PostgresJsQueryResultHKT,
      typeof schema,
...
export const getGlobalIdentifierById = (db: DatabaseConnection) => async (id: string) => {
  return db
    .select()
