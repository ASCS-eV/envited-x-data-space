  ...
  try {
    ...
    const memberCredential = {
      ...
      "proof": {
        ...
        "proofValue": "edsigtzevcJza3fCTZpraJZaqmeN641T6Sce8uCe7F63q43TdChp93NAffEbieNnNRQXHk4i1ChgYAjAcYyDLHGSWRYMhvkSexP",
    ...
    const userCredential =  {
      ...
      "proof": {
        ...
        "type": "TezosSignature2021",
        "proofPurpose": "assertionMethod",
        "proofValue": "edsigtbbW7BBBJsueVHEbvXiHTjqu64gbTxYgRDSMLWofVa851PHTabW4j8eRPsXmDrNsL7h1GGWJtAg19Eu9sqmWiY7psAi5Yi",
    ...
    const user = await database.getUserByDid({ method: 'did:pkh', namespace: 'tezos', chainId: 'NetXnHfVqm9iesp', nss: 'tz1QiMF7KNwmabgo5fkchacKh5niBK9Xai7y' })
    console.log(user)

    const userRoles = await database.getUserRolesByDid({ method: 'did:pkh', namespace: 'tezos', chainId: 'NetXnHfVqm9iesp', nss: 'tz1QiMF7KNwmabgo5fkchacKh5niBK9Xai7y' })
