...
export const _getProfile =
  ...
  async () => {
    try {
      ...
      if (
        hasCredentialType('ASCS User')(user.usersToCredentialTypes) ||
        hasCredentialType('AscsUserCredential')(user.usersToCredentialTypes)
      ) {
        const principal = await connection.getUserByIssuerId(user.issuerId)
      ...
      if (
        hasCredentialType('ASCS Participant')(user.usersToCredentialTypes) ||
        hasCredentialType('AscsMemberCredential')(user.usersToCredentialTypes)
      ) {
