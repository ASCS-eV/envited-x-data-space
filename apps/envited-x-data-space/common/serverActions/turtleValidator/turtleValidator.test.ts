...
describe('common/serverActions/turtleValidator', () => {
  describe('readShaclFile', () => {
    it('Should return a valid result', async () => {
      ...
      const shapeFile = `${process.cwd()}/apps/envited-x-data-space/common/fixtures/shaclSchema.ttl`
      const dataFile = `${process.cwd()}/apps/envited-x-data-space/common/fixtures/shaclData.jsonld`
