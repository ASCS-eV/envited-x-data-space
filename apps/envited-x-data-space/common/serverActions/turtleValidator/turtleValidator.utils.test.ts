...
describe('common/serverActions/turtleValidator.utils', () => {
  ...
  describe('validateShacl', () => {
    it('Should return a valid report', async () => {
      const shapes = `${process.cwd()}/apps/envited-x-data-space/common/fixtures/shaclSchema.ttl`
      const data = `${process.cwd()}/apps/envited-x-data-space/common/fixtures/shaclData.jsonld`
