    ...
    <div className="isolate overflow-hidden bg-gray-900 h-screen">
      <div className="mx-auto max-w-7xl px-6 pb-48 pt-24 text-center sm:pt-48 lg:px-8">
        <div className="mx-auto max-w-4xl">
          <h2 className="text-base font-semibold leading-7 text-blue-800">{t('[Heading] error')}</h2>
          <p className="mt-2 text-4xl font-bold tracking-tight text-white sm:text-5xl">{t(`[Heading] ${type}`)}</p>
          <p className="mt-6 text-base leading-7 text-white">{t(`[Description] ${type}`)}</p>
        </div>
