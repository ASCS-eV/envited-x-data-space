...
export default function Envited({ stack }: StackContext) {
      ...
      processAssetUpload: {
        function: {
          ...
          environment: {
            ...
            NEXT_PUBLIC_PRIVATE_RESOURCES_BUCKET_NAME: privateResourcesBucket.bucketName,
            NEXT_PUBLIC_PUBLIC_RESOURCES_BUCKET_NAME: publicResourcesBucket.bucketName,
            PINATA_JWT: process.env.PINATA_JWT!,
            PINATA_GATEWAY: process.env.PINATA_GATEWAY!,
            PINATA_GATEWAY_KEY: process.env.PINATA_GATEWAY_KEY!,
            ASSETS_URL: process.env.ASSETS_URL!,
            PRIVATE_RESOURCES_URL: process.env.PRIVATE_RESOURCES_URL!,
          },
  ...
  const site = new NextjsSite(stack, `envited_x_data_space-${stack.stage}`, {
    ...
    environment: {
      ...
      NEXT_PUBLIC_UPLOADS_BUCKET_NAME: process.env.NEXT_PUBLIC_UPLOADS_BUCKET_NAME!,
      NEXT_PUBLIC_PRIVATE_RESOURCES_BUCKET_NAME: process.env.NEXT_PUBLIC_PRIVATE_RESOURCES_BUCKET_NAME!,
      ...
      PINATA_GATEWAY: process.env.PINATA_GATEWAY!,
      PINATA_GATEWAY_KEY: process.env.PINATA_GATEWAY_KEY!,
      TEZOS_ASSETS_CONTRACT: process.env.TEZOS_ASSETS_CONTRACT!,
