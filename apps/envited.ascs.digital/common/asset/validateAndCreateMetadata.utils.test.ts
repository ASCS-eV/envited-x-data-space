        ...
        'hdmap:general': {
          ...
          'general:links': {
            ...
            'general:media': {
              ...
              'general:url': {
                '@value':
                  './asset/documentation/Gaia_X_Example_Asset_TestfeldNiedersachsen_ALKS_ODR_technicalDocumentation.pdf',
                '@type': 'xsd:anyURI',
              },
            ...
            'general:media': {
              ...
              'general:url': {
                '@value':
                  './asset/documentation/Gaia_X_Example_Asset_TestfeldNiedersachsen_ALKS_ODR_technicalDocumentation_stats.txt',
                '@type': 'xsd:anyURI',
              },
              'general:type': 'Document',
            },
